...
_lr_productions = [
  ...
  ('elem -> list','elem',1,'p_elem','day12-b.py',38),
  ('elem -> dict','elem',1,'p_elem','day12-b.py',39),
  ('elem -> number','elem',1,'p_elem','day12-b.py',40),
  ('elem -> name','elem',1,'p_elem','day12-b.py',41),
  ('empty -> <empty>','empty',0,'p_empty','day12-b.py',45),
  ('number -> MINUS NUMBER','number',2,'p_number','day12-b.py',49),
  ('number -> NUMBER','number',1,'p_number','day12-b.py',50),
  ('name -> QUOTE NAME QUOTE','name',3,'p_name','day12-b.py',57),
  ('list -> LSQUARE list_elem RSQUARE','list',3,'p_list','day12-b.py',61),
  ('list_elem -> empty','list_elem',1,'p_list_elem','day12-b.py',65),
  ('list_elem -> elem','list_elem',1,'p_list_elem','day12-b.py',66),
  ('list_elem -> elem COMMA list_elem','list_elem',3,'p_list_elem','day12-b.py',67),
  ('dict -> LCURLY dict_list RCURLY','dict',3,'p_dict','day12-b.py',71),
  ('dict_list -> empty','dict_list',1,'p_dict_list','day12-b.py',75),
  ('dict_list -> dict_elem','dict_list',1,'p_dict_list','day12-b.py',76),
  ('dict_list -> dict_elem COMMA dict_list','dict_list',3,'p_dict_list','day12-b.py',77),
  ('dict_elem -> name COLON elem','dict_elem',3,'p_dict_elem','day12-b.py',81),
]
